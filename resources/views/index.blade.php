<!doctype html>
<html lang="en" data-layout="vertical" data-sidebar="dark" data-sidebar-size="sm-hover" data-preloader="disable"
    data-bs-theme="light">
    ...
    <div id="layout-wrapper">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <button type="button"
                    class="btn btn-sm p-0 fs-3xl header-item float-end btn-vertical-sm-hover shadow-none"
                    id="vertical-hover">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="/index" class="nav-link" data-key="t-analytics"> Analytics </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="dashboard-ecommerce.html" class="nav-link" data-key="t-ecommerce">
                                            Ecommerce </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link collapsed" href="#sidebarLayouts" data-bs-toggle="collapse"
                                ...
                                <i class="ti ti-layout-board"></i> <span data-key="t-layouts">Layouts</span> <span
                        ...
                        <li class="nav-item">
                            <a href="apps-calendar.html" class="nav-link menu-link"> <i class="ti ti-calendar"></i>
                                <span data-key="t-calendar">Calendar</span> </a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-chat.html" class="nav-link menu-link"> <i class="ti ti-messages"></i> <span
                                    data-key="t-chat">Chat</span> </a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-email.html" class="nav-link menu-link"> <i class="ti ti-mail"></i> <span
                                    data-key="t-email">Email</span> </a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-file-manager.html" class="nav-link menu-link"> <i
                                    class="ti ti-folders"></i> <span data-key="t-file-manager">File Manager</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-to-do.html" class="nav-link menu-link"> <i class="ti ti-list"></i> <span
                                    data-key="t-to-do">To Do</span> </a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-contacts.html" class="nav-link menu-link"> <i
                                    class="ti ti-address-book"></i> <span data-key="t-contacts">Contacts</span> </a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-kanbanboard.html" class="nav-link menu-link"> <i class="ti ti-subtask"></i>
                                <span data-key="t-kanaban-board">Kanban Board</span> </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="auth-signin.html" class="nav-link" role="button"
                                            data-key="t-signin"> Sign In </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="auth-signup.html" class="nav-link" role="button"
                                    ...
                                    <li class="nav-item">
                                        <a href="auth-logout.html" class="nav-link" role="button"
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarErrors">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="auth-404.html" class="nav-link" data-key="t-404-error">
                                                        404 Error </a>
                                                </li>
                                                <li class="nav-item">
                        ...
                        <li class="menu-title"><i class="ti ti-dots"></i> <span
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link collapsed" href="#sidebarUI2" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="sidebarPages">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="forms-checkboxs-radios.html" class="nav-link"
                                            data-key="t-checkboxes-radios">Checkboxes & Radios</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarIcons">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="icons-bootstrap.html" class="nav-link"
                                            data-key="t-bootstrap">Bootstrap</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="icons-phosphor.html" class="nav-link"
                                            data-key="t-phosphor">Phosphor</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse"
                                ...
                                <i class="ti ti-brand-stackshare"></i> <span data-key="t-multi-level">Multi
                                    Level</span>
                            </a>
                        ...
                        <form class="app-search d-none d-md-inline-flex">
                            <div class="position-relative">
                                <input type="text" class="form-control border-0"
                                    placeholder="Search for anything..." autocomplete="off" id="search-options"
                                    value="">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar style="max-height: 320px;">
                                    ...
                                    <div class="dropdown-header">
                                        <h6 class="text-overflow fs-sm text-muted mb-0 text-uppercase">Recent Searches
                                        </h6>
                                    </div>

                                    <div class="dropdown-item bg-transparent text-wrap">
                                        <a href="/index" class="btn btn-subtle-secondary btn-sm btn-rounded">how
                                            to setup <i class="ti ti-search ms-1"></i></a>
                                        <a href="/index"
                    ...
                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-block dropdown-item product text-wrap p-2">
                                            <div class="d-flex">
                                                ...
                                                <div
                                                    ...
                                                    <h6 class="mb-0">$ <span
                                                            class="product-line-price">654.98</span></h6>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#removeCartModal"><i
                                                            class="ri-close-fill fs-lg"></i></button>
                                                    <h6 class="mb-0">$ <span
                                                            class="product-line-price">147.18</span></h6>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#removeCartModal"><i
                                                            class="ri-close-fill fs-lg"></i></button>
                                                    <h6 class="mb-0">$ <span
                                                            class="product-line-price">159.99</span></h6>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-block dropdown-item product text-wrap p-2">
                                            <div class="d-flex">
                                                <div class="avatar-sm me-3 flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="/assets/images/products/img-11.png"
                                                            class="avatar-xs" alt="user-pic">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#removeCartModal"><i
                                                            class="ri-close-fill fs-lg"></i></button>
                                                    <h6 class="mb-0">$ <span
                                                            class="product-line-price">164.37</span></h6>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#removeCartModal"><i
                                                            class="ri-close-fill fs-lg"></i></button>
                                                    <h6 class="mb-0">$ <span
                                                            class="product-line-price">180.00</span></h6>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar-xs me-3 flex-shrink-0">
                                                    <span
                                                        class="avatar-title bg-success-subtle text-success rounded-circle fs-lg">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-0 fs-xs fw-medium text-uppercase text-muted">
                                                        <span><i class="ti ti-clock-hour-4"></i> Just 30 sec
                                                            ago</span>
                                                    </p>
                                                </div>
                        ...
                        <div class="dropdown ms-sm-3 topbar-head-dropdown dropdown-hover-end header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item fs-sm" href="pages-profile.html"><i
                                        class="bi bi-person-circle text-muted align-middle me-1"></i> <span
                                        class="align-middle">Profile</span></a>
                                <a class="dropdown-item fs-sm" href="apps-calendar.html"><i
                                        class="bi bi-cart4 text-muted align-middle me-1"></i> <span
                                        class="align-middle">Order Track</span></a>
                                <a class="dropdown-item fs-sm" href="apps-chat.html"><i
                                        class="bi bi-box-seam text-muted align-middle me-1"></i> <span
                                        class="align-middle">Chat</span></a>
                                <a class="dropdown-item fs-sm" href="apps-to-do.html"><span
                                        class="badge bg-success-subtle text-success float-end ms-2">New</span><i
                                        class="bi bi-cassette text-muted align-middle me-1"></i> <span
                                        class="align-middle">To Do</span></a>
                                ...
                                <a class="dropdown-item fs-sm" href="auth-logout.html"><i
                    ...
                    <div class="row">
                            ...
                            <div>
                                <div class="row gy-4">
                                    <div class="col-sm-4 border-end-sm">
                                        <div class="text-center">
                                            <p class="text-uppercase fw-medium text-muted text-truncate fs-md">Total
                                                Sessions</p>
                                            <h4 class="fw-semibold mb-3"><span class="counter-value"
                                                    data-target="476.32">0</span>k </h4>
                                ...
                                <div class="mt-4">
                                    <div class="mx-n4">
                                        <div id="performance_overview"
                                            data-colors='["--tb-primary", "--tb-warning"]' class="apex-charts"
                                            dir="ltr"></div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3 d-flex gap-3">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar-sm">
                                                        <div
                                                            class="avatar-title bg-body-secondary text-secondary rounded fs-3xl">
                                                            <i class="ti ti-brand-facebook"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="text-muted mb-2">Facebook <span
                                                            class="badge bg-success-subtle text-success"><i
                                                                class="ti ti-arrow-up-right"></i> 2.59%</span></p>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3 d-flex gap-3">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar-sm">
                                                        <div
                                                            class="avatar-title bg-body-secondary text-danger rounded fs-3xl">
                                                            <i class="ti ti-brand-instagram"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="text-muted mb-2">Instagram <span
                                                            class="badge bg-success-subtle text-success"><i
                                                                class="ti ti-arrow-up-right"></i> 4.05%</span></p>
                                                    <h6 class="fw-semibold mb-0"><span class="counter-value"
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3 d-flex gap-3">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar-sm">
                                                        <div
                                                            class="avatar-title bg-body-secondary text-info rounded fs-3xl">
                                                            <i class="ti ti-brand-twitter"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="text-muted mb-2">Twitter <span
                                                            class="badge bg-danger-subtle text-danger"><i
                                                                class="ti ti-arrow-down-right"></i> 1.67%</span></p>
                                                    <h6 class="fw-semibold mb-0"><span class="counter-value"
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3 d-flex gap-3">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar-sm">
                                                        <div
                                                            class="avatar-title bg-body-secondary text-body rounded fs-3xl">
                                                            <i class="ti ti-world"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="text-muted mb-2">Website <span
                                                            class="badge bg-success-subtle text-success"><i
                                                                class="ti ti-arrow-up-right"></i> 3.12%</span></p>
                                                    <h6 class="fw-semibold mb-0"><span class="counter-value"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card" id="contactList">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Campaign performance by source
                                                </h4>
                                                <div class="flex-shrink-0">
                                                    <div class="dropdown card-header-dropdown sortble-dropdown">
                                                        <a class="text-reset dropdown-btn fs-sm" href="#"
                                                            data-bs-toggle="dropdown" aria-haspopup="true"
                                                            aria-expanded="false">
                                                            <span class="fw-semibold text-uppercase">Sort by:
                                                            </span><span
                                                                class="text-muted dropdown-title">Source</span> <i
                                                                class="ti ti-chevron-down ms-1"></i>
                                                        </a>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <button class="dropdown-item sort"
                                                                data-sort="source">Source</button>
                                                            <button class="dropdown-item sort"
                                                                data-sort="impression">Impression</button>
                                                            <button class="dropdown-item sort"
                                                        ...
                                                        <thead class="text-muted table-light">
                                                            <tr>
                                                                <th scope="col" class="sort cursor-pointer"
                                                                    data-sort="source">Source</th>
                                                                <th scope="col" class="sort cursor-pointer"
                                                                    data-sort="impression">Impression</th>
                                                                <th scope="col" class="sort cursor-pointer"
                                                                    data-sort="clicks">Clicks</th>
                                                                <th scope="col" class="sort cursor-pointer"
                                                                    data-sort="cost">Cost</th>
                                                                <th scope="col" class="sort cursor-pointer"
                                                                    data-sort="conversation">Conversion</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody class="list">
                                                            <tr>
                                                    ...
                                                    <div class="noresult" style="display: none">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="text-muted mb-0">We've searched more than 150+
                                                                transactions We did not find any transactions for you
                                                                search.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="card-body">
                                                <div class="mx-n3" data-simplebar style="max-height: 478px;">
                                                    <div class="d-flex gap-2 mb-3">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/chrome.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <h6>12.74k <small
                                                                    class="text-muted fw-normal">/Session</small></h6>
                                                            <p class="text-muted fs-md mb-0">Chrome</p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                            <div class="dropdown">
                                                                <button class="btn shadow-none btn-sm btn-icon"
                                                    ...
                                                    <div class="d-flex gap-2 mb-3">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/firefox.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex gap-2 mb-3">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/cloud-computing.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex gap-2 mb-3">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/safari.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex gap-2 mb-3">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/opera.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex gap-2 mb-3">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/microsoft.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <div class="avatar-title bg-body-secondary rounded">
                                                                <img src="/assets/images/brands/chromium.png"
                                                                    alt="" class="avatar-xxs">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                    ...
                                    <div class="col-xxl-9">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div id="balance_overview"
                                                    data-colors='["--tb-primary", "--tb-success","--tb-info"]'
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-start"><i
                                                                        class="ti ti-point-filled align-baseline me-1 text-primary"></i>
                                                                    Total Revenue</td>
                                                                <th>$795.69k</th>
                                                                <td class="text-muted"><span class="text-success"><i
                                                                            class="bi bi-caret-up-fill align-baseline me-1"></i>
                                                                        6.19%</span> than last years</td>
                                                                <td class="text-end" style="width: 150px;"><a
                                                                        href="#!"
                                                                        class="icon-link icon-link-hover text-decoration-underline link-underline link-underline-opacity-0 link-underline-opacity-75-hover">View
                                                                        All <i class="bi bi-arrow-right"></i></a></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-start"><i
                                                                        class="ti ti-point-filled align-baseline me-1 text-success"></i>
                                                                    Total Expenses</td>
                                                                <th>$415.37k</th>
                                                                <td class="text-muted"><span class="text-success"><i
                                                                            class="bi bi-caret-up-fill align-baseline me-1"></i>
                                                                        3.62%</span> than last years</td>
                                                                <td class="text-end" style="width: 150px;"><a
                                                                        href="#!"
                                                                        class="icon-link icon-link-hover text-decoration-underline link-underline link-underline-opacity-0 link-underline-opacity-75-hover">View
                                                                        All <i class="bi bi-arrow-right"></i></a></td>
                                                            ...
                                                            <tr>
                                                                <td class="text-start"><i
                                                                        class="ti ti-point-filled align-baseline me-1 text-info"></i>
                                                                    Profit Ratio </td>
                                                                <th>3.6%</th>
                                                                <td class="text-muted"><span class="text-danger"><i
                                                                            class="bi bi-caret-down-fill align-baseline me-1"></i>
                                                                        1.47%</span> than last years</td>
                                                                <td class="text-end" style="width: 150px;"><a
                                                                        href="#!"
                                                                        class="icon-link icon-link-hover text-decoration-underline link-underline link-underline-opacity-0 link-underline-opacity-75-hover">View
                                                                        All <i class="bi bi-arrow-right"></i></a></td>
                        ...
                        <div class="col-xl-4">
                            <div class="d-none d-xl-block">
                                <div
                                    class="card bg-success-subtle shadow-none rounded-0 border-0 dashboard-widgets-wrapper">
                                    <div class="card-body text-center mt-5 pt-5">
                                        <h5>Welcome to Alexandra</h5>
                                        <p class="text-muted fs-md  ">There is the latests update for the last 7 days,
                                            check now</p>
                            ...
                            <div class="mt-xl-5 pt-xl-4">
                                <div class="card card-height-100">
                                    ...
                                    <div class="card-body">
                                        <div id="realized_rate"
                                            data-colors='["--tb-warning", "--tb-success", "--tb-danger"]'
                                    ...
                                    <div class="card-body vstack gap-2">
                                        <div class="d-flex bg-body-secondary rounded">
                                            ...
                                            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
                                                ...
                                                <p class="text-muted fs-sm text-truncate mb-0">This is a periodic
                                                    meeting between sales and marketing aimed at ensuring initial and
                                                    ongoing alignment between the two groups.</p>
                                            </div>
                                        </div>
                                        <div class="d-flex bg-body-secondary rounded">
                                            <div class="flex-shrink-0 w-md py-2 px-3 text-center border-end">
                                            ...
                                            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
                                                ...
                                                <p class="text-muted fs-sm text-truncate mb-0">Designers aim to create
                                                    interfaces which users find easy to use and pleasurable.</p>
                                            </div>
                                        </div>
                                        <div class="d-flex bg-body-secondary rounded">
                                            <div class="flex-shrink-0 w-md py-2 px-3 text-center border-end">
                                            ...
                                            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
                                                ...
                                                <p class="text-muted fs-sm text-truncate mb-0">Event banners are one
                                                    of the many ways to use print marketing for your business.</p>
                                            </div>
                                        </div>
                                        <div class="d-flex bg-body-secondary rounded">
                                            <div class="flex-shrink-0 w-md py-2 px-3 text-center border-end">
                                            ...
                                            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
                                                ...
                                                <p class="text-muted fs-sm text-truncate mb-0">Contact your unhappy
                                                    customer and be personable. Use their first name and apologize as
                                                    necessary.</p>
                                            </div>
                                        </div>
                                        <div class="d-flex bg-body-secondary rounded">
                                            ...
                                            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
                                                ...
                                                <p class="text-muted fs-sm text-truncate mb-0">Ecommerce dashboards
                                                    aggregate the most important performance metrics, so online sellers
                                                    can track their progress and quickly respond to any changes.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="card card-height-100">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="dropdown card-header-dropdown flex-shrink-0">
                                        <a class="text-reset dropdown-btn fs-md" href="#"
                                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="text-muted">This Month<i
                                                    class="ti ti-chevron-down ms-1"></i></span>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <div class="card-body">
                                    <div id="usersActivity" data-colors='["--tb-primary", "--tb-primary-rgb, 0.75"]'
                                        class="apex-charts" dir="ltr"></div>
                                </div>
                            </div>
                        </div><!--end col-->
                            ...
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-4" style="height: 34px;">
                                        <div class="progress-bar" data-bs-toggle="tooltip" data-bs-title="Mobile"
                                            role="progressbar" style="width: 30%" aria-valuenow="30"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                        <div class="progress-bar bg-success" data-bs-toggle="tooltip"
                                            data-bs-title="Tables" role="progressbar" style="width: 25%"
                                            aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                        <div class="progress-bar bg-info" data-bs-toggle="tooltip"
                                            data-bs-title="Laptop" role="progressbar" style="width: 37%"
                                            aria-valuenow="37" aria-valuemin="0" aria-valuemax="100"></div>
                                        <div class="progress-bar bg-warning" data-bs-toggle="tooltip"
                                            data-bs-title="Others" role="progressbar" style="width: 8%"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card border-4 border-bottom border-primary mb-0">
                                                <div class="card-body text-center">
                                                    <h6 class="fs-lg mb-2"><span class="counter-value"
                                                            data-target="1523">0</span>k</h6>
                        ...
                        <div class="col-xl-3">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="shades_heatmap"
                                        data-colors='["--tb-info-rgb, 0.7", "--tb-info-rgb, 0.35"]'
                                        class="apex-charts ms-n3" dir="ltr"></div>
                                </div>
                            </div>
                        </div><!--end col-->
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="dropdown">
                                            <button class="btn shadow-none btn-sm btn-icon" type="button"
                                ...
                                <div class="card-body">
                                    <div id="semi_radialbar" data-colors='["--tb-secondary"]' class="apex-charts"
                                        dir="ltr"></div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="progress bg-light">
                                        ...
                                        <div class="progress-bar progress-bar-animated bg-success progress-bar-striped"
                                            role="progressbar" style="width: 31%" aria-valuenow="31"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="d-flex mt-2 align-items-center fs-md">
                                        <p class="mb-0 flex-grow-1"><i
                                                class="ti ti-rotate-rectangle fs-xs text-primary"></i> Returning</p>
                                        <p class="mb-0"><i class="ti ti-rotate-rectangle fs-xs text-success"></i>
                                            New</p>
                                    </div>
                                </div>
                            </div>
